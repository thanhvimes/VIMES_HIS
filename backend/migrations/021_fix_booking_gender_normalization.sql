-- Migration: 021_fix_booking_gender_normalization.sql
-- Purpose: Update public.qms_patient_create_booking stored procedure to normalize gender input ('nam', 'nữ', 'm', 'f', etc.) to 'M' or 'F' before insertion.
