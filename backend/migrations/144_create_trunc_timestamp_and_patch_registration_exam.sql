-- Migration 144: Create trunc(timestamp) compatibility function and update hms_exm_registration_exam
-- Description: Định nghĩa hàm trunc(timestamp) và tối ưu so sánh ngày trong hms_exm_registration_exam
