...
≡ƒÜÇ Running SQL from: D:\AI\vClinic\backend\sql\get_func_def_2.sql
...
BEGIN
    ...
    -- 1. Xß╗¼ L├¥ Bß╗åNH NH├éN (HMS_PATIENT)
    ...
    -- 2. Nß║╛U L├Ç Bß╗åNH NH├éN Mß╗ÜI -> Tß║áO Bß╗åNH NH├éN
	...
	ELSE
		 -- 3. Xß╗¼ L├¥ Hß╗Æ S╞á KH├üM TRONG NG├ÇY (HMS_DOC)
