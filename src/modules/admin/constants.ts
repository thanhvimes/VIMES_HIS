...
export const ADMIN_NAV_ITEMS: NavItemType[] = [
    { name: 'Bảng điều khiển', path: '/admin/dashboard', icon: React.createElement(Squares2X2Icon, { className: "w-5 h-5" }) },
    ...
    { name: 'Tin tức & Sự kiện', path: '/admin/news', icon: React.createElement(NewspaperIcon, { className: "w-5 h-5" }) }, // New Item
