                ...
                <div className="flex flex-col md:flex-row gap-4 items-stretch">
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 text-sm">
                        ...
                        <div className="space-y-2">
                            <div>
                                <h2 className="text-lg font-bold text-blue-700 dark:text-blue-400 uppercase leading-tight break-words">
                                    {patientRecord.name}
                                </h2>
                                <div className="flex items-center gap-2 text-slate-600 dark:text-slate-400 mt-1 flex-wrap">
                        ...
                        <div className="space-y-2 pt-1 border-t md:border-t-0 border-slate-100 dark:border-slate-700 md:pl-4 md:border-l">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <span className="text-slate-700 dark:text-slate-300 break-words">{patientRecord.occupation || '---'}</span>
                            </div>
                            <div className="flex items-start gap-2">
                            ...
                            <div className="mb-3">
                                <div className="flex items-center justify-between mb-1 gap-2 flex-wrap">
                                    ...
                                    {patientRecord.hasInsurance ? (
                                        <span className="flex items-center gap-1 text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-100 whitespace-nowrap">
                                            <CheckBadgeIcon className="w-3 h-3"/> BHYT (80%)
                                        </span>
                                    ) : (
                                        <span className="text-[10px] font-bold text-slate-600 bg-slate-100 px-2 py-0.5 rounded whitespace-nowrap">Dịch vụ</span>
                                    )}
                                </div>
                                {patientRecord.hasInsurance && (
                                    <div className="text-xs text-slate-600 dark:text-slate-400 break-all" title={patientRecord.insuranceNumber}>
                            ...
                            <div className="mt-auto pt-2 border-t border-slate-100 dark:border-slate-700">
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex justify-between text-xs gap-2">
                                        ...
                                        <span className="font-bold text-slate-700 dark:text-slate-200 whitespace-nowrap">Dr. Minh</span>
                                    </div>
                                    <div className="flex justify-between items-center text-xs gap-2">
                                        <span className="text-slate-500">Hướng xử lý:</span>
                                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold bg-purple-50 text-purple-700 border border-purple-200 dark:bg-purple-900/20 dark:text-purple-300 dark:border-purple-800 whitespace-nowrap">
                                            Nhập viện
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-4">
                        {[
                            ...
                            <div key={item.label} className="flex flex-col items-start border-l pl-3 first:border-l-0 border-slate-100 dark:border-slate-700">
                                <span className="text-[10px] font-bold text-slate-400 uppercase whitespace-nowrap">{item.label}</span>
                                <div className="flex items-baseline gap-1 w-full flex-wrap">
