    ...
    const startCamera = async (deviceIdOverride?: string) => {
        ...
        try {
            ...
            if (err.name === 'NotAllowedError' || err.name === 'PermissionDeniedError') {
                ...
                setError("Lỗi kết nối Camera. Vui lòng kiểm tra lại thiết bị.");
            }
        }
    };
                        ...
                        <div className="relative w-full h-full flex items-center justify-center overflow-hidden" ref={overlayRef}>
                            {error ? (
                                <div className="text-center p-6 max-w-md">
                                    ...
                                    {permissionError ? (
                                        <div className="text-sm text-yellow-500 bg-yellow-500/10 p-3 rounded mb-4">
                                            <p className="font-bold mb-1">Cách khắc phục:</p>
                                            <ol className="list-decimal list-inside text-left">
                                                <li>Nhấn vào biểu tượng 🔒 (ổ khóa) trên thanh địa chỉ trình duyệt.</li>
                                                <li>Tìm mục "Camera" và chọn "Cho phép" (Allow).</li>
