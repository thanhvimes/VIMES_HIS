...
const smsTemplateRoutes = require('./routes/sms-template.routes'); // NEW: SMS Template routes
const receptionRoutes = require('./routes/reception.routes'); // NEW: Reception routes
...
app.use('/api/v1/settings', settingsRoutes); // NEW: Settings routes
app.use('/api/v1/sms-templates', smsTemplateRoutes); // NEW: SMS Template routes
app.use('/api/v1/reception', receptionRoutes); // NEW: Reception routes
