...
export const ONLINE_BOOKING_NAV_ITEMS: NavItemType[] = [
  ...
  { name: 'Thiết lập phòng khám', path: '/online-booking/room-setup', icon: React.createElement(BuildingOfficeIcon, { className: "w-5 h-5" }), section: 'QUẢN TRỊ', iconName: 'BuildingOfficeIcon' },
  { name: 'Cấu hình lịch khám', path: '/online-booking/settings', icon: React.createElement(CogIcon, { className: "w-5 h-5" }), section: 'QUẢN TRỊ', iconName: 'CogIcon' },
];
