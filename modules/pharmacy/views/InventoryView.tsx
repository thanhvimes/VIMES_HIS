...
interface InventoryItem extends Drug {
    batchNumber: string;
    importDate: string;
    expiryDate: string;
    category: string;
  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 flex-1 overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-sm text-slate-500 flex justify-between items-center flex-shrink-0">
            <span>Hiển thị {filteredInventory.length} thuốc trong kho</span>
            <div className="flex gap-2">
                <button className="px-3 py-1 border border-slate-300 dark:border-slate-600 rounded hover:bg-white dark:hover:bg-slate-700 disabled:opacity-50">Trước</button>
                <button className="px-3 py-1 border border-slate-300 dark:border-slate-600 rounded hover:bg-white dark:hover:bg-slate-700 disabled:opacity-50">Sau</button>
            </div>
        </div>
      </div>
    </div>
