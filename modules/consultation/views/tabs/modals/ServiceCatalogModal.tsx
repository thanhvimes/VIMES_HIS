...
import { XIcon, SearchIcon, PlusIcon, CheckIcon } from '../../../../../components/Icons';
import { ServiceItem, serviceCategories, serviceList } from '../../../data/catalogs';
...
const ServiceCatalogModal: React.FC<ServiceCatalogModalProps> = ({ isOpen, onClose, onSelect }) => {
    ...
    // Count items selected in each category for badges
            ...
            <div className="bg-white dark:bg-slate-800 w-full h-full max-h-[90vh] md:max-w-5xl rounded-xl shadow-2xl flex flex-col overflow-hidden animate-fade-in-up">
                        ...
                        <div className="p-2 space-y-1">
                            {serviceCategories.map(cat => (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-3 rounded-lg text-sm font-medium transition-all flex justify-between items-center ${
                                        selectedCategoryId === cat.id 
                                        ? 'bg-white dark:bg-slate-700 text-blue-600 dark:text-blue-400 shadow-sm border-l-4 border-blue-500' 
                        ...
                        <div className="p-4 border-b border-slate-100 dark:border-slate-700">
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full pl-10 p-2.5 text-sm border border-slate-300 dark:border-slate-600 rounded-lg bg-slate-50 dark:bg-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                />
                            </div>
                        </div>
                                ...
                                filteredItems.map(item => {
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className={`flex items-center px-4 py-3 border-b border-slate-100 dark:border-slate-800 cursor-pointer transition-colors ${
                                        ...
                                        >
                                            ...
                                            <div className="w-24 text-right text-sm font-bold text-slate-700 dark:text-slate-300">
                ...
                <div className="flex-shrink-0 p-4 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 flex justify-between items-center">
                    <div className="text-sm text-slate-600 dark:text-slate-300">
                        Đã chọn: <span className="font-bold text-blue-600 dark:text-blue-400 text-lg">{selectedItems.size}</span> dịch vụ
                    </div>
                    <div className="flex gap-3">
                        ...
                        <button 
                            ...
                            className="px-6 py-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center gap-2"
                        >
