    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col h-full">
            ...
            <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50 dark:bg-slate-900/50 flex-shrink-0">
                <div>
                    <h3 className="text-lg font-bold text-orange-600 dark:text-orange-400 uppercase flex items-center gap-2">
                        <ActivityIcon className="w-5 h-5"/> {data.name}
                    </h3>
            ...
            <div className="px-6 py-4 bg-white dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700 flex-shrink-0">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-3 bg-orange-50 dark:bg-orange-900/10 rounded-lg border border-orange-100 dark:border-orange-900/30">
                        <h4 className="text-xs font-bold text-orange-700 dark:text-orange-400 mb-3 uppercase border-b border-orange-200 dark:border-orange-800 pb-1">Thông tin chỉ định</h4>
                    ...
                    {/* Column 2: Kết quả */}
                    <div className="p-3 bg-orange-50 dark:bg-orange-900/10 rounded-lg border border-orange-100 dark:border-orange-900/30">
                        <h4 className="text-xs font-bold text-orange-700 dark:text-orange-400 mb-3 uppercase border-b border-orange-200 dark:border-orange-800 pb-1">Thông tin kết quả</h4>
                     ...
                     {/* Column 3: Thực hiện */}
                     <div className="p-3 bg-orange-50 dark:bg-orange-900/10 rounded-lg border border-orange-100 dark:border-orange-900/30">
                        <h4 className="text-xs font-bold text-orange-700 dark:text-orange-400 mb-3 uppercase border-b border-orange-200 dark:border-orange-800 pb-1">Thông tin thực hiện</h4>
            ...
            <div className="flex-1 overflow-auto p-6 space-y-6">
                ...
                {functionalData.chartData && (
                    <div className="h-64 w-full bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-lg p-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {Object.entries(functionalData.metrics).map(([key, value]) => (
                        <div key={key} className="bg-orange-50 dark:bg-orange-900/10 p-3 rounded-lg border border-orange-100 dark:border-orange-800/50">
                            <div className="text-xs text-orange-600 dark:text-orange-400 uppercase font-bold mb-1">{key}</div>
                            <div className="text-lg font-semibold text-slate-800 dark:text-slate-200">{value}</div>
                        </div>
                    ))}
                </div>
                ...
                <div className="space-y-4">
                     <div className="pb-3 border-b border-slate-100 dark:border-slate-700">
                        <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wide mb-1">Mô tả kết quả</h4>
                     ...
                     <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-700">
                        <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wide mb-1">Kết luận</h4>
