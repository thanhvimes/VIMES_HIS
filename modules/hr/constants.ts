...
export const HR_NAV_ITEMS: NavItemType[] = [
    { name: 'Tổng quan HR', path: '/hr/dashboard', icon: React.createElement(Squares2X2Icon, { className: "w-5 h-5" }) },
    { name: 'Hồ sơ Nhân sự', path: '/hr/staff', icon: React.createElement(UserCircleIcon, { className: "w-5 h-5" }) },
    { name: 'Chấm công & Ca trực', path: '/hr/scheduling', icon: React.createElement(CalendarDaysIcon, { className: "w-5 h-5" }) },
    { name: 'Lương & Phúc lợi', path: '/hr/payroll', icon: React.createElement(CashIcon, { className: "w-5 h-5" }) },
    { name: 'Tuyển dụng', path: '/hr/recruitment', icon: React.createElement(UserAddIcon, { className: "w-5 h-5" }) },
    { name: 'Đào tạo & Đánh giá', path: '/hr/training', icon: React.createElement(StarIcon, { className: "w-5 h-5" }) },
