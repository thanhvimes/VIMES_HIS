        ...
        <SpecialtyCard specialtyKey="dermatology" title="Khám Da Liễu">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select value={khamDaLieuPl} onChange={e => setKhamDaLieuPl(e.target.value)} className="w-full p-2.5 border border-slate-300 dark:border-slate-600 rounded-lg text-sm bg-white dark:bg-slate-700 text-slate-800 dark:text-white font-medium">
