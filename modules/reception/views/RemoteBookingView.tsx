                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="date" value={bookingData.dob} onChange={e => setBookingData({...bookingData, dob: e.target.value})} className="w-full p-2.5 border rounded-lg dark:bg-slate-900" />
                                </div>
                                <div>
                            ...
                            <section>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" value={bookingData.date} onChange={e => setBookingData({...bookingData, date: e.target.value})} className="w-full p-2.5 border rounded-lg dark:bg-slate-900 font-bold" />
                                    </div>
                                </div>
                            </section>
