...
const SurgeryForm: React.FC<SurgeryFormProps> = ({ formData, onChange, onImagesChange }) => {
    const [options, setOptions] = React.useState<CatalogItem[]>(surgeryOptions);
    ...
    const handleSearch = async (query: string) => {
        ...
        setIsLoading(true);
        try {
            const response = await consultationService.getOperationCatalog(query, 'PT');
            if (response.success) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="col-span-1 md:col-span-3">
                    <Combobox<CatalogItem> 
                        ...
                        required 
                        placeholder="Tìm kiếm tên phẫu thuật..." 
