...
export const FileSignatureIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
    </svg>
);

export const InkPenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
    </svg>
);

// ... rest of icons (Surgeon, etc.) ...
...
export const SyringeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        {/* Custom simple syringe representation */}
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 19.5l-15-15" />
    </svg>
);
// Actually replacing Syringe with a better vector if available, or reusing existing structure
// For now, using standard icons available in Heroicons set or similar

export const KnifeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
// ... Rest of the file (HospitalIcon, etc.) remains unchanged ...
...
export const BedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 9.75v10.5c0 .414.336.75.75.75h16.5a.75.75 0 00.75-.75V9.75M3 9.75h18M3 9.75V6.75a3 3 0 013-3h12a3 3 0 013 3v3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 14.25v2.25m10-2.25v2.25" />
  </svg>
);
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6.343 6.343l1.414-1.414M17.657 6.343l-1.414-1.414M12 21a9 9 0 100-18 9 9 0 000 18zM12 3v4m0 14V11m-2.293 2.293l-1.414 1.414M16.243 16.243l1.414 1.414" />
  </svg>
);
...
export const TruckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h2a1 1 0 001-1V6h2a1 1 0 011 1v9a1 1 0 01-1 1h-1m-6-4h4" />
    </svg>
);
...
export const QrcodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 5h3v3H5V5zm0 8h3v3H5v-3zm8-8h3v3h-3V5zm0 8h3v3h-3v-3zM9 9v6H3V9h6zm8 0v6h-6V9h6zM9 3h6v2H9V3zM3 9V3h2v6H3zm12 0V3h2v6h-2zm-6 8h6v2H9v-2zm-6 0v-6H3v2h2v4H3zm12 0v-6h-2v6h2z" />
  </svg>
);

export const ShieldCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.955a12.02 12.02 0 009 3.001 12.02 12.02 0 009-3.001 12.02 12.02 0 00-2.382-9.011z" />
  </svg>
);
...
export const StethoscopeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2M9 10h6m-5 6h4m-5-2h5m1 4v1m3-3v1M12 21c5.523 0 10-4.477 10-10S17.523 1 12 1 2 5.477 2 11s4.477 10 10 10z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2a3 3 0 013 3v7.828a2 2 0 01-.586 1.414l-2.828 2.828A2 2 0 0110.172 16H12z" />
  </svg>
);
...
// --- NEW ICONS FOR EQUIPMENT & LIS MODULE ---
...
export const CpuChipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-1.5 3.75h1.5m-1.5-7.5h1.5m-1.5 3.75h1.5m-1.5-7.5h1.5M12 3v1.5m0 15v1.5m3.75-18v1.5m0 15v1.5m-9-1.5v1.5m0-15v1.5m3.75 11.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5zm0 0v-1.5m0 0c.648 0 1.207.258 1.622.672a2.25 2.25 0 01-3.244 0A2.25 2.25 0 0110.5 13.5m1.5 0V9M9.75 15h-1.5M15 15h-1.5m0-6H12m-1.5 0H9" />
  </svg>
);
...
export const IdentificationIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm1.294 6.336a6.721 6.721 0 01-1.294-1.579 6.721 6.721 0 01-1.294 1.579 5.317 5.317 0 00-1.205.488C6.255 16.864 7.395 17.25 8.625 17.25c1.23 0 2.37-.386 3.625-1.05.413-.219.816-.384 1.205-.488z" />
  </svg>
);
